...
<template>
  <button
    ...
    :class="['grid place-content-center relative shadow text-red-600 rounded-full w-12 h-12 outline-none', hasItems ? 'hover:bg-secondary/50 focus:bg-secondary/50 active:shadow-inner' : 'opacity-50']"
    :disabled="!hasItems"
  >
