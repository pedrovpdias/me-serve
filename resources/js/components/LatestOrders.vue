...
<template>
  <div class="flex flex-col gap-4 w-fit text-sm flex-1">
    ...
    <div class="flex justify-end">
      <router-link to="/pedidos" class="bg-secondary w-full text-sm font-semibold py-1 px-2 text-center hover:bg-primary/10 focus:bg-primary/10 active:shadow-inner outline-none">
        Ver todos
      </router-link>
    </div>
  </div>
